...
},xhr=>{if(xhr.total){const p=Math.min(100,xhr.loaded/xhr.total*100);bar.style.width=p+'%';status.textContent='Downloading Citadel scene… '+p.toFixed(0)+'%';}},
err=>fail('Citadel assets failed to load',err));
